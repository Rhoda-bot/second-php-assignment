...
if (isset($_POST['create'])) {
  ...
  if ($title==null || $body==null) {
    ...
    $select_query = "INSERT INTO `post_tb`(`title`, `body`, `id`) VALUES ('$title','$body','$userId')";
    $query = mysqli_query($connect,$select_query);
    if ($query) {
     echo "Successfully created Post";
    //  header("Location: http://localhost/BlogAssignment/home.php","refresh: 3");
    //  exit();
    //  sleep(3);
     }else {
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-12 card border shadow-sm p-3 mb-5 bg-white rounded pt-3 ">
      <?php if (isset($fetch_User) and count($fetch_User ) > 0): 
